...
<div class="row">
    <form method="POST" action="{{ route('games.store') }}">
        ...
        <div class="mb-3">
          ...
          <input type="text" class="form-control" name="game-name" id="game-name" aria-describedby="game-title">
        </div>
        <div class="mb-3">
          ...
          <div class="mb-3">
            ...
            <input type="date" class="form-control" name="release-date" id="release-date"  aria-describedby="release_date">
          </div>
          <div class="mb-3">
            <label for="summary" class="form-label">Game Summary</label>
            <input type="text" class="form-control" name="summary" id="summary"  aria-describedby="summary">
          </div>
